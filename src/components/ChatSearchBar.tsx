...
export function ChatSearchBarWithoutSearch() {
  return (
    <div className="flex text-grey">
      <div className="flex items-center px-md">
        <GoBackIcon />
      </div>
      <div className="w-full flex rounded-md bg-grey/20 text-grey py-sm">
        <input
          type="text"
          className="pl-sm w-full outline-none bg-transparent text-black"
          placeholder="대화 검색하기"
...
export function SearchIcon() {
  return (
    <svg fill="currentColor" viewBox="0 0 16 16" width="1.25em" height="1.25em">
...
export function GoBackIcon() {
  return (
    <svg fill="currentColor" viewBox="0 0 20 20" width="1.25em" height="1.25em">
